...
export function RoutingActivationBrand({
  ...
  return (
    <div className="relative isolate inline-flex items-center gap-2">
      {showBurst && (
        <motion.span
      ...
      <motion.span
        className="relative z-10 flex h-7 w-7 shrink-0 items-center justify-center overflow-hidden rounded-md bg-black shadow-sm ring-1 ring-black/10 dark:ring-white/10"
        animate={
          showBurst
            ? { scale: [1, 0.96, 1.075, 1], rotate: [0, -2, 2, 0] }
            : { scale: 1, rotate: 0 }
        }
        transition={
          showBurst
      ...
      <motion.span
        className={cn(
          "relative z-10 hidden text-lg font-semibold tracking-normal transition-colors duration-500 sm:inline",
          active
