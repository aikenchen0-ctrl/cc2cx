...
//!
//! Parses cclaunch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a cclaunch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// cclaunch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "cclaunch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'cclaunch', got '{scheme}'"
        )));
    }
